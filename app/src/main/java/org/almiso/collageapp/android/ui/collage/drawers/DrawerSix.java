 ...
 */
public class DrawerSix extends BaseDrawer {

    public static final int FRAMES_COUNT = 3;

    public DrawerSix(CollageObject object) {
        super(object);
    }
    ...
    private void draw6v1() {
        ...
        rectF1.set(
                ...
                contentArea.left + contentArea.width() - indentPhoto,
                contentArea.top + contentArea.height() - indentPhoto);
        canvas.drawBitmap(((images[5] == null) ? emptyBitmap : images[5]), null, rectF1, photoPaint);
    }

    private void draw6v3() {
        rectF1.set(
                contentArea.left + indentPhoto,
                contentArea.top + +indentPhoto,
